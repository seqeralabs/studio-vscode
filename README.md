...
- **[OpenVSCode Server](https://github.com/gitpod-io/openvscode-server) v1.105.1** — browser-based VS Code
...
```
public.cr.seqera.io/platform/data-studio-vscode:1.105.1-0.13.0
```
